...
export const copy = {
  en: {
    ...
    subtitle: "LLMs playing «Contact» game",
    language: "Language",
    settings: "Settings",
    ...
    aiModels: "AI Models",
    useSameModel: "Use same model for all AI roles",
    allRolesModel: "All AI roles",
    provider: "Provider",
    model: "Model",
  ...
  ru: {
    ...
    aiModels: "AI-модели",
    useSameModel: "Одна модель для всех AI-ролей",
    allRolesModel: "Все AI-роли",
    provider: "Провайдер",
    model: "Модель",
    providerConfigured: "настроен",
    providerMissingKey: "нет API-ключа",

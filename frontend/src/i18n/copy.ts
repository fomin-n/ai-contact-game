...
export const copy = {
  en: {
    ...
    aiModels: "AI Models",
    useSameModel: "Use one model for all roles",
  ...
  ru: {
    ...
    aiModels: "AI-модели",
    useSameModel: "Одна модель для всех ролей",
    ...
    currentSetup: "Настройка:",
    forAllRoles: "для всех ролей",
    statusReady: "Настроен",
    statusIncomplete: "Не настроен",
